...
export const helpData: HelpData = {
  ...
  "contents": [
    { "key": "feature_list", "title": "Feature List" },
    { "key": "opening_map", "title": "Opening the Map and Getting Started" },
    { "key": "search", "title": "Search Around the World" },
    { "key": "movement", "title": "How to Move Through Places" },
    { "key": "zooming", "title": "Zooming" },
    { "key": "inbound_navigation", "title": "Inbound Navigation" },
    { "key": "adjustable_pointer", "title": "Exploring the Surroundings (Adjustable Pointer)" },
    { "key": "distance_finder", "title": "Finding Distance" },
